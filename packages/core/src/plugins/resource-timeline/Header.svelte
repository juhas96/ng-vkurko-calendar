<script>
    ...
    import {setContent, toISOString, toSeconds, observeResize, getWeekNumber, isHoliday} from '#lib';
    import {isSunday} from "date-fns";

    let {_headerEl, _headerHeight,_intlDayHeader, _intlDayHeaderAL,_intlMonthHeader, _dayTimes, _viewDates, _weekDays, _daysInWeek, slotDuration, theme, holidays} = getContext('state');
</script>
