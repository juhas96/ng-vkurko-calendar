import { SvelteComponentDev, init, safe_not_equal, dispatch_dev, ensure_array_like_dev, validate_slots, validate_store, component_subscribe, set_store_value, empty, insert_dev, noop as noop$1, detach_dev, destroy_each, element, text, attr_dev, add_location, append_dev, listen_dev, set_data_dev, is_function, action_destroyer, run_all, prop_dev, transition_in, group_outros, check_outros, transition_out, space, create_component, mount_component, destroy_component, construct_svelte_component_dev, set_style } from 'svelte/internal';
...
const file$2 = "packages/core/src/Buttons.svelte";
...
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ ctx[5].button + (/*$view*/ ctx[9] === /*button*/ ctx[34]
			? ' ' + /*$theme*/ ctx[5].active
			: '') + " ec-" + /*button*/ ctx[34]));

			add_location(button_1, file$2, 90, 8, 3050);
		},
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*$buttonText, buttons*/ 129 && t_value !== (t_value = /*$buttonText*/ ctx[7][/*button*/ ctx[34]] + "")) set_data_dev(t, t_value);
...
function create_if_block_4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ ctx[5].button + " ec-" + /*button*/ ctx[34] + (/*$customButtons*/ ctx[8][/*button*/ ctx[34]].active
			? ' ' + /*$theme*/ ctx[5].active
			: '')));

			add_location(button_1, file$2, 84, 8, 2772);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button_1, anchor);
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			button_1 = element("button");
			t = text(t_value);
			attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ ctx[5].button + " ec-" + /*button*/ ctx[34]));
			button_1.disabled = /*todayDisabled*/ ctx[1];
			add_location(button_1, file$2, 78, 8, 2539);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button_1, anchor);
			append_dev(button_1, t);
			...
			if (!mounted) {
				dispose = listen_dev(button_1, "click", /*click_handler*/ ctx[28], false, false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*todayDisabled*/ 2) {
				prop_dev(button_1, "disabled", /*todayDisabled*/ ctx[1]);
			}
		},
		d: function destroy(detaching) {
			if (detaching) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			button_1 = element("button");
			i = element("i");
			attr_dev(i, "class", i_class_value = "" + (/*$theme*/ ctx[5].icon + " ec-" + /*button*/ ctx[34]));
			add_location(i, file$2, 76, 9, 2447);
			attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ ctx[5].button + " ec-" + /*button*/ ctx[34]));
			attr_dev(button_1, "aria-label", button_1_aria_label_value = /*$buttonText*/ ctx[7].next);
			attr_dev(button_1, "title", button_1_title_value = /*$buttonText*/ ctx[7].next);
			button_1.disabled = /*nextDisabled*/ ctx[4];
			add_location(button_1, file$2, 70, 8, 2239);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button_1, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(button_1, "click", /*next*/ ctx[23], false, false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*nextDisabled*/ 16) {
				prop_dev(button_1, "disabled", /*nextDisabled*/ ctx[4]);
			}
		},
		d: function destroy(detaching) {
			if (detaching) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			i = element("i");
			attr_dev(i, "class", i_class_value = "" + (/*$theme*/ ctx[5].icon + " ec-" + /*button*/ ctx[34]));
			add_location(i, file$2, 68, 9, 2148);
			attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ ctx[5].button + " ec-" + /*button*/ ctx[34]));
			attr_dev(button_1, "aria-label", button_1_aria_label_value = /*$buttonText*/ ctx[7].prev);
			attr_dev(button_1, "title", button_1_title_value = /*$buttonText*/ ctx[7].prev);
			button_1.disabled = /*prevDisabled*/ ctx[3];
			add_location(button_1, file$2, 62, 8, 1940);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button_1, anchor);
			append_dev(button_1, i);
			...
			if (!mounted) {
				dispose = listen_dev(button_1, "click", /*prev*/ ctx[22], false, false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*prevDisabled*/ 8) {
				prop_dev(button_1, "disabled", /*prevDisabled*/ ctx[3]);
			}
		},
		d: function destroy(detaching) {
			if (detaching) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			h2 = element("h2");
			attr_dev(h2, "class", h2_class_value = /*$theme*/ ctx[5].title);
			add_location(h2, file$2, 60, 8, 1838);
		},
		m: function mount(target, anchor) {
...
function create_each_block$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(58:0) {#each buttons as button}",
		ctx
	});
...
function instance$3($$self, $$props, $$invalidate) {
	...
	validate_store(validRange, 'validRange');
	...
	function prev() {
		set_store_value(date, $date = prevDate($date, {...$duration, months: 1}, $hiddenDays), $date);
	}

	function next() {
		set_store_value(date, $date = nextDate($date, {...$duration, months: 1}), $date);
	}
	...
	$$self.$inject_state = $$props => {
		if ('buttons' in $$props) $$invalidate(0, buttons = $$props.buttons);
		if ('_currentRange' in $$props) $$invalidate(10, _currentRange = $$props._currentRange);
		if ('_viewTitle' in $$props) $$invalidate(11, _viewTitle = $$props._viewTitle);
		if ('_viewDates' in $$props) $$invalidate(12, _viewDates = $$props._viewDates);
		if ('buttonText' in $$props) $$invalidate(13, buttonText = $$props.buttonText);
		if ('customButtons' in $$props) $$invalidate(14, customButtons = $$props.customButtons);
		if ('date' in $$props) $$invalidate(15, date = $$props.date);
		if ('duration' in $$props) $$invalidate(16, duration = $$props.duration);
		if ('hiddenDays' in $$props) $$invalidate(17, hiddenDays = $$props.hiddenDays);
		if ('theme' in $$props) $$invalidate(18, theme = $$props.theme);
		if ('validRange' in $$props) $$invalidate(19, validRange = $$props.validRange);
		if ('view' in $$props) $$invalidate(20, view = $$props.view);
		if ('today' in $$props) $$invalidate(21, today = $$props.today);
		if ('prevDisabled' in $$props) $$invalidate(3, prevDisabled = $$props.prevDisabled);
		if ('nextDisabled' in $$props) $$invalidate(4, nextDisabled = $$props.nextDisabled);
		if ('todayDisabled' in $$props) $$invalidate(1, todayDisabled = $$props.todayDisabled);
...
const file$1 = "packages/core/src/Toolbar.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 25, 20, 638);
		},
		m: function mount(target, anchor) {
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$1, 22, 8, 509);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(nav, file$1, 20, 0, 436);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
const file = "packages/core/src/Calendar.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 140, 0, 3592);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
